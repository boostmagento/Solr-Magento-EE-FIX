                ...
                if (empty($facetFieldConditions)) {
                    ...
                    foreach ($facetFieldConditions as $facetCondition) {
                        if (is_array($facetCondition) && isset($facetCondition['from'])
                            ...
                            $from = (isset($facetCondition['from']) && strlen(trim($facetCondition['from']))&& trim($facetCondition['from']) !== "*")            //zsolt
                                ? $this->_prepareQueryText($facetCondition['from'])
                                : '*';
                            $to = (isset($facetCondition['to']) && strlen(trim($facetCondition['to']))&& trim($facetCondition['to']) !== "*")                    //zsolt
